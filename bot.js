...
module.exports = builder(function (message, apiRequest) {
    try {
        var dynamo_1 = new aws_sdk_1.DynamoDB.DocumentClient();
        var dialogue = new dialogue_builder_1.Dialogue(onboarding_1.default, {
            retrieve: function () {
                return __awaiter(this, void 0, void 0, function () {
                    var user;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, dynamo_1.get({
                            ...
                            case 1:
                                user = _a.sent();
                                return [2 /*return*/, user.Item['state']];
                        }
                    });
                });
            },
            store: function (state) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, dynamo_1.put({
                                    TableName: 'pointless-bot-users',
        ...
        var messages = dialogue.consume(message);
